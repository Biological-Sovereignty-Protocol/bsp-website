...
const content = computed(() => {
  if (lang.value === 'pt') {
    return {
      ...
      f2Text: "Toda solicitação exige permissão do titular verificada on-chain via Aptos. Seus dados só se movem quando você assina criptograficamente.",
      ...
      openBannerSub: "Liquidação on-chain via Aptos. Armazenamento permanente via Arweave. Aberto para sempre.",
    ...
    return {
      ...
      f2Text: "Todo requerimiento de acceso necesita aprobación verificada on-chain vía Aptos. La información sólo se traslada si lo firmas criptográficamente.",
      ...
      openBannerSub: "Liquidación on-chain vía Aptos. Almacenamiento permanente vía Arweave. Abierto para siempre.",
  ...
  return {
    ...
    f1Text: "The individual owns their BEO and all BioRecords within it for life, with the right to cryptographically erase at any time. Hosted on the decentralized Arweave network, no company can revoke access — but you can.",
    f2Title: "Granular Consent",
    f2Text: "Every third-party access request requires explicit BEO-holder consent verified on-chain via Aptos. Your data only moves when you cryptographically sign for it.",
    ...
    step3Text: "Your data lives on Arweave with permanent integrity. Only you can erase it — by destroying your key.",
    howItWorksTitle: "How It Works",

    openBannerTitle: "Open Standard. Open Source.",
    openBannerSub: "Settled on Aptos. Stored permanently on Arweave. Open forever.",
    ...
    uc3Desc: 'The Exchange API lets consented BioRecords flow between individuals, researchers, and AI systems — stored on Arweave with full erasure rights.',
    ...
    beoCtaDesc: 'Your BEO is a permanent cryptographic identity anchored to you — with full control to erase at any time. Create yours in minutes — no account needed, no central database.',
    ...
    faq2A: 'All data is stored on the Arweave network, a decentralized storage blockchain. No company can delete or revoke your access — but you retain the right to cryptographically erase your data at any time by destroying your private key.',
