...
const content = computed(() => {
  if (lang.value === 'pt') {
    return {
      ...
      f2Text: "Toda solicitação exige permissão do titular via processo AO. Seus dados só se movem quando você assina criptograficamente.",
    ...
    return {
      ...
      f2Text: "Todo requerimiento de acceso necesita la aprobación vía proceso AO. La información sólo se traslada si lo firmas criptográficamente.",
  ...
  return {
    ...
    f2Text: "Every third-party access request requires explicit BEO-holder consent via the AO process. Your data only moves when you cryptographically sign for it.",
