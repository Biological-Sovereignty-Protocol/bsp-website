...
Control of your BEO is determined by a **private key (Ed25519)** stored securely in your device's hardware enclave (e.g., Apple Secure Enclave). The access control rules (ConsentTokens) are enforced by Move smart contracts on Aptos, making them mathematically immune to unauthorized bypass.
